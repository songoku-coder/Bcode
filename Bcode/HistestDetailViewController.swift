//
//  HistestDetailViewController.swift
//  Bcode
//
//  Created by jian sun on 2019/03/18.
...
//        likeButton.addTarget(self, action: #selector(historyUpdate(_:)), for: .touchDown)
    ...
    //realm データ保存Update
    @objc func historyUpdate(_ sender: HistestCustomButton){
...
class HistestCustomButton:UIButton {
    // 引数として使用する
    var argument:String?
}
